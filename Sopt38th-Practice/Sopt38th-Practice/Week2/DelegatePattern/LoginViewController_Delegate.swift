...
extension LoginViewController_Delegate: UITextFieldDelegate {
...
extension LoginViewController_Delegate: RetryLoginDelegateProtocol {
    func retryLogin(id: String) {
        idTextField.text = ""
        passwordTextField.text = ""
        titleLabel.text = "\(id)님, 다시 로그인하십쇼"
    }
}
